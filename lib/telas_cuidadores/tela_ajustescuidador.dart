...
class DatabaseService {
  ...
  final CollectionReference userCollection =
      FirebaseFirestore.instance.collection('users-caregivers');
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: ChangeNotifierProvider(
        ...
        child: MySettingsCuidadorPage(),
      ),
    );
  }
}

class MySettingsCuidadorPage extends StatefulWidget {
  @override
  _MySettingsCuidadorPageState createState() => _MySettingsCuidadorPageState();
}

class _MySettingsCuidadorPageState extends State<MySettingsCuidadorPage> {
